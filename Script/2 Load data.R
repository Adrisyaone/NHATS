...
tr_data<-pull_data(data_sp, wave_range=1:14,wt_range = 0:56, pattern="^(hc|cg|fl|r|cp|rd|ia|sd|hh|hw|rl|pn|pa|wr)[0-9]+", tracker = "TR")

sen_data <-pull_data(data_sp, wave_range=1:14,wt_range = 0:56, pattern="^(hc|cg|fl|r|cp|rd|ia|sd|hh|hw|rl|pn|pa|wr)[0-9]+", tracker = "SEN")
